...
uint32_t RG_Ratio_typical_Truly=0x4e;//LINE <> <DATE20130408> <truly ov8825 RG/BG typical value> wupingzhou
uint32_t BG_Ratio_typical_Truly=0x4b;//LINE <> <DATE20130408> <truly ov8825 RG/BG typical value> wupingzhou
...
int update_otp_wb(void)
{
	...
	//add by buxiangyu for distinguish diffrent moudle Truly or Liteon
	OV8825DB("[Sunny] #########current_otp->customer_id = 0x%x\n",current_otp.customer_id);
    ...
    //calculate gain
    //0x400 = 1x gain
    OV8825DB("[Sunny] #########current_otp.bg_ratio = 0x%x\n",current_otp.bg_ratio);
    OV8825DB("[Sunny] #########current_otp.rg_ratio = 0x%x\n",current_otp.rg_ratio);
    OV8825DB("[Sunny] #########RG_Ratio_typical = 0x%x\n",RG_Ratio_typical);
    OV8825DB("[Sunny] #########BG_Ratio_typical = 0x%x\n",BG_Ratio_typical);

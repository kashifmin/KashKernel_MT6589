...
static struct i2c_board_info __initdata i2c_tpd={ I2C_BOARD_INFO("S3203", (0x72))};
...
static void tpd_down(int x, int y, int p)
{
	...
	printk("tpd_down  s3202_lishengli  D[%4d %4d %4d]\n", x, y, p);
...
static void tpd_up(int x, int y)
{
	...
	printk("tpd_up s3202_lishengli U[%4d %4d %4d]\n", x, y, 0);
...
static int tpd_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
    ...
    printk("%s:enter s3202_lishengli \n",__func__);
...
err_alloc_data_failed:
       ...
       printk("%s:exit s3202_lishengli , ret = %d  \n",__func__, ret);
	return ret;
}
...
static int tpd_local_init(void)
{
	...
	printk("S3203_lishengli I2C Touchscreen Driver (Built %s @ %s)\n", __DATE__, __TIME__);
...
static int __init tpd_driver_init(void)
{
	...
	printk("S3203_lishengli touch panel driver init\n");

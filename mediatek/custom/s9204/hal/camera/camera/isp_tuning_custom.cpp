...
#include "kd_imgsensor.h"//LINE <> <DATE201304015> <sunny MTM ov8825 tuning para 0413> wupingzhou
...
//BEGIN <> <DATE201304015> <sunny MTM ov8825 tuning para 0413> wupingzhou
    //MINT32 const THL2	= 4500;
    //MINT32 const THH2	= 4700;
    //MINT32 const TH2	= (THL2+THH2)/2;//(THL2 +THH2)/2    TH2 = 9828/2=4914   CCT=4764
    MINT32 THL2	= 4500;
    MINT32 THH2	= 4700;
    MINT32 TH2	= (THL2+THH2)/2;//(THL2 +THH2)/2    TH2 = 9828/2=4914   CCT=4764
//END <> <DATE201304015> <sunny MTM ov8825 tuning para 0413> wupingzhou
...
//BEGIN <> <DATE201304015> <sunny MTM ov8825 tuning para 0413> wupingzhou
	...
	else if(sensorID == OV8835MIPI_SENSOR_ID)
	{
		THL1	= 3950;
   		THH1	= 4200;
    	TH1	= (THL1+THH1)/2; //(THL1 +THH1)/2
		...
		LOGD("[-evaluate_Shading_CCT_index][OV8835MIPI] This is truly OV8835 module.");
	}
	else if(sensorID == OV12830_SENSOR_ID_TRULY)
	{
		THL1	= 3700;
   		THH1	= 4100;
    	TH1	= (THL1+THH1)/2; //(THL1 +THH1)/2
//		TH3			= -70;
		...
		LOGD("[-evaluate_Shading_CCT_index][OV12830MIPI] This is truly OV12830 module.");
	}
	else if(sensorID == OV8826_SENSOR_ID)
	{
		LOGD("[-evaluate_Shading_CCT_index][OV8826MIPI] This is sunny MTM module.");
	}
	else
	{
		LOGD("[-evaluate_Shading_CCT_index][OV8826MIPI] This is other OV8825 module.");
...
#if 0
			if (sensorID == OV8835MIPI_SENSOR_ID)//LINE <> <DATE20130705> <truly ov8835 tuning 0705> wupingzhou
			{
			    if(i4CCT >5100)
			        eIdx_Shading_CCT_new = eIDX_Shading_CCT_D65;
				else
...
#endif
			if (sensorID == OV12830_SENSOR_ID_TRULY)
			{
				if(i4SceneLV < 71 )
				{
					if(i4DFIDX < 70)
				...
				else if(i4SceneLV < 73 && i4DFIDX < TH3)
				{
					eIdx_Shading_CCT_new = eIDX_Shading_CCT_CWF;
				}
				else

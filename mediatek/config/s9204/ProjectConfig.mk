...
BUILD_PRELOADER = yes
BUILD_UBOOT = no
CUSTOM_BUILD_VERNO = S9204P_MP_IN_MMX_19_FLASHER_USER
...
CUSTOM_MODEM = tinno89_we_jb2_md1_hspa_P18
...
INTERNAL_BUILD_VERNO = S9204P_MP_IN_MMX_08_23
...
MTK_PRODUCT_LOCALES = en_US en_IN de_DE de_CH fr_FR in_ID it_IT pt_BR tr_TR ldpi xhdpi hdpi mdpi hdpi
...
MTK_VIDEO_1080P = no
MTK_VIDEO_FAVORITES_WIDGET_APP = no #yes
...
TUI_APP_BACKUPRESTORE = no #yes
TUI_APP_BROWSER = no #yes
TUI_APP_CALCULATOR = no #yes
TUI_APP_CALENDAR = no #yes
TUI_APP_CELLCONNSERVICE = no #yes
TUI_APP_CONTACTS = no #yes
TUI_APP_DESKCLOCK = no #yes
TUI_APP_EMAIL = no #yes
TUI_APP_FILEMANAGER = no #yes
TUI_APP_FMRADIO = no #yes
TUI_APP_GALLERY2 = no #yes
TUI_APP_LATINIME = no #yes
TUI_APP_LAUNCHER2 = no #yes
TUI_APP_LIVEPICKER = no #yes
TUI_APP_MMS = no #yes
TUI_APP_MUSIC = no #yes
TUI_APP_MUSICFX = no #yes
TUI_APP_OOBE = no #yes
TUI_APP_PACKAGEINSTALLER = no #yes
TUI_APP_PHONE = no #yes
TUI_APP_PHOTOTABLE = no #yes
TUI_APP_POWERSAVING = no
TUI_APP_RINGTONE = no #yes
TUI_APP_SCHEDULEPOWERONOFF = no #yes
TUI_APP_SETTINGS = no #yes
TUI_APP_SOUNDRECORDER = no #yes
TUI_APP_STK1 = no #yes
TUI_APP_SYSTEMFONT = no #add system font
TUI_APP_SYSTEMUI = no #yes
TUI_APP_THEMESETTINGS = no #yes
TUI_APP_TINNOFLOW = no #yes
TUI_APP_TINNOLED = no #yes
TUI_APP_TINNOWEATHERWIDGET = no #yes
TUI_APP_TPUPGRADE = no #yes
TUI_APP_VIDEOPLAYER = no #yes
TUI_APP_VIDEOPLAYERWIDGET = no #yes
TUI_APP_VOICEUNLOCK = no #yes
TUI_SUPPORT = no #yes
